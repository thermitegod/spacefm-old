...
static void clipboard_get_data(GtkClipboard* clipboard, GtkSelectionData* selection_data, uint info,
                               gpointer user_data)
{
...
void ptk_clipboard_paste_files(GtkWindow* parent_win, const char* dest_dir, GtkTreeView* task_view, GFunc callback,
                               GtkWindow* callback_win)
{
    GtkClipboard* clip = gtk_clipboard_get(GDK_SELECTION_CLIPBOARD);
    ...
    if (uri_list_str)
    {
        char** uri_list;
        GList* files = NULL;
        char** puri = uri_list = g_uri_list_extract_uris(uri_list_str);
        while (*puri)
        {
...
void ptk_clipboard_paste_links(GtkWindow* parent_win, const char* dest_dir, GtkTreeView* task_view, GFunc callback,
                               GtkWindow* callback_win)
{
    GtkClipboard* clip = gtk_clipboard_get(GDK_SELECTION_CLIPBOARD);
    VFSFileTaskType action;
...
void ptk_clipboard_paste_targets(GtkWindow* parent_win, const char* dest_dir, GtkTreeView* task_view, GFunc callback,
                                 GtkWindow* callback_win)
{
    GtkClipboard* clip = gtk_clipboard_get(GDK_SELECTION_CLIPBOARD);
    VFSFileTaskType action;
