...
#if (GTK_MAJOR_VERSION == 3)
    gtk_box_pack_start( GTK_BOX( hbox_view_buttons ),
                        GTK_WIDGET(gtk_separator_new(GTK_ORIENTATION_VERTICAL)), TRUE, TRUE, 4);
#elif (GTK_MAJOR_VERSION == 2)
    gtk_box_pack_start( GTK_BOX( hbox_view_buttons ),
