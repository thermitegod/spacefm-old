...
static void exo_cell_renderer_ellipsized_text_get_property(GObject* object, guint prop_id, GValue* value,
                                                           GParamSpec* pspec);
static void exo_cell_renderer_ellipsized_text_set_property(GObject* object, guint prop_id, const GValue* value,
                                                           GParamSpec* pspec);
...
#if (GTK_MAJOR_VERSION == 3)
static void exo_cell_renderer_ellipsized_text_get_preferred_width(GtkCellRenderer* renderer, GtkWidget* widget,
                                                                  gint* minimal_size, gint* natural_size);
static void exo_cell_renderer_ellipsized_text_get_preferred_height(GtkCellRenderer* renderer, GtkWidget* widget,
                                                                   gint* minimal_size, gint* natural_size);
static void exo_cell_renderer_ellipsized_text_get_preferred_height_for_width(GtkCellRenderer* renderer,
...
#if (GTK_MAJOR_VERSION == 3)
    gtkcell_renderer_class->get_preferred_width = exo_cell_renderer_ellipsized_text_get_preferred_width;
    gtkcell_renderer_class->get_preferred_height_for_width =
        exo_cell_renderer_ellipsized_text_get_preferred_height_for_width;
    gtkcell_renderer_class->get_preferred_height = exo_cell_renderer_ellipsized_text_get_preferred_height;
#endif
                                                           ...
                                                           GParamSpec* pspec)
{
    ExoCellRendererEllipsizedTextPrivate* priv =
        exo_cell_renderer_ellipsized_text_get_instance_private(EXO_CELL_RENDERER_ELLIPSIZED_TEXT(object));
...
{
    ExoCellRendererEllipsizedTextPrivate* priv =
        exo_cell_renderer_ellipsized_text_get_instance_private(EXO_CELL_RENDERER_ELLIPSIZED_TEXT(renderer));
    ...
    // sfm-gtk3
#if (GTK_MAJOR_VERSION == 3)
    (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)->get_preferred_width)(renderer,
                                                                                                    widget,
                                                                                                    &text_width,
                                                                                                    NULL);
    (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)
          ->get_preferred_height_for_width)(renderer, widget, text_width, &text_height, NULL);
#elif (GTK_MAJOR_VERSION == 2)
    (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)
          ->get_size)(renderer, widget, NULL, NULL, NULL, &text_width, &text_height);
#endif
                                                     ...
                                                     GtkCellRendererState flags)
{
    ...
    else
    {
        ...
        if ((flags & (GTK_CELL_RENDERER_FOCUSED | GTK_CELL_RENDERER_SELECTED)) != 0)
        {
            ...
            gtk_cell_renderer_get_size(renderer, widget, &text_area, &x0, &y0, &text_width, &text_height);
#elif (GTK_MAJOR_VERSION == 2)
            (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)
                  ->get_size)(renderer, widget, &text_area, &x0, &y0, &text_width, &text_height);
#endif
    ...
    (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)->render)(renderer,
