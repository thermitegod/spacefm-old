...
static void exo_cell_renderer_icon_class_init(ExoCellRendererIconClass* klass)
{
    ...
    g_object_class_install_property(
        gobject_class,
        PROP_ICON,
        g_param_spec_string("icon", _("Icon"), _("The icon to render."), NULL, EXO_PARAM_READWRITE));
    ...
    g_object_class_install_property(
        gobject_class,
        PROP_GICON,
        g_param_spec_object("gicon", _("GIcon"), _("The GIcon to render."), G_TYPE_ICON, EXO_PARAM_READWRITE));
                                          ...
                                          GtkCellRendererState flags)
{
    ...
    else if (priv->icon != NULL || priv->gicon != NULL)
    {
        ...
        {
            icon_info =
                gtk_icon_theme_lookup_by_gicon(icon_theme, priv->gicon, priv->size, GTK_ICON_LOOKUP_USE_BUILTIN);
        }
